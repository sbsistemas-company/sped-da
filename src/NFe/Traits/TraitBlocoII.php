...
trait TraitBlocoII
{
    ...
    protected function PosII($pos)
    {
        //$this->bloco2H = 12;
        //$aFont = ['font'=> $this->fontePadrao, 'size' => 7, 'style' => ''];
        //$this->pdf->textBox($this->margem, $y, $this->wPrint, $this->bloco2H, '', $aFont, 'T', 'C', true, '', false);
        if ($this->tpEmis == 9) {
            $pos .= "<font.B><center>Documento Auxiliar da Nota Fiscal de Consumidor Eletronica<br>Nao permite aproveitamento de credito de ICMS<br>EMITIDA EM CONTINGÊNCIA<br></center><line></font.B>";

        } else {
            $pos .= "<font.B><center>Documento Auxiliar da Nota Fiscal de Consumidor Eletronica<br>Nao permite aproveitamento de credito de ICMS</font.B></center><br><line>";
        }
